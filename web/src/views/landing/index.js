        ...
        <div className='hero-body'>
          <div className='container'>
            ...
            <div className='hero-inner'>
              ...
              <div>
                <h2 className='title has-text-white'>Sokol's Stock Visualizer</h2>
                <h6 className='subtitle has-text-white'>
                    Helping you create your best portfolio.</h6>
                  <div className='banner-buttons'>
                    <button style={{marginRight: '15px'}} className='button is-info is-inverted has-text-dark'>
                      Get Started
                    </button>
                  </div>
              </div>
              <br />
                <div className='banner-image'>
                    <img src='banner.png' alt='logo' width='70%'/>
                </div>
            </div>
            ...
            <div className='columns is-variable is-7'>
              <div className='column'>
                <div className='notification has-background-white bordered'>
                  ...
                  <h3 className='title has-text-weight-light'>Completely Free</h3>
          ...
          <div className='content has-text-centered'>
            ...
            <div className='serving-nc-wrapper' >
              ...
              <div className='serving-nc'>
                <img src='northcarolina.png' alt='nc' width='200' className='nc-image'/>
